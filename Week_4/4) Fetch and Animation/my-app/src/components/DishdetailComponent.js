        ...
        return (
            <div className="col-md-5">
                <div className="col-12 m-1">
                    ...
                    <CommentForm dishId={dishId} postComment={postComment} />  {/* Comment Form for the current dish that you have clicked (for each dish there will be different comment form)*/}
                </div>
            </div >
        )
    } else {
